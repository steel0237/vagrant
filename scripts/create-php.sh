...
tar zxvf php.tar.gz
cd php-$ver
./configure --with-config-file-path=/etc/php/7.1/cli --with-config-file-scan-dir=/etc/php/7.1/cli/conf.d  --prefix=/usr/local/php7 --enable-intl --with-mcrypt --with-pdo-pgsql --with-curl --with-openssl \
...
--with-xsl --enable-bcmath --enable-sysvmsg --enable-sysvsem --enable-sysvshm --enable-maintainer-zts --enable-cli --with-tsrm-pthreads
make && make install && make clean


./configure --with-config-file-path=/etc/php/7.1/fpm --with-config-file-scan-dir=/etc/php/7.1/fpm/conf.d  --prefix=/usr/local/php7 --enable-intl --with-mcrypt --with-pdo-pgsql --with-curl --with-openssl \
--with-zlib --enable-mbstring --enable-ftp --enable-sockets --with-pgsql --enable-pcntl --with-pspell --with-enchant --with-gettext --with-gd --enable-exif --with-jpeg-dir --with-png-dir --with-freetype-dir \
--with-xsl --enable-bcmath --enable-sysvmsg --enable-sysvsem --enable-sysvshm --enable-maintainer-zts --with-tsrm-pthreads \
--disable-cli --enable-fpm --with-fpm-user=www-data --with-fpm-group=www-data
make && make install && make clean
